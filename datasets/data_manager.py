...
class DataSet(object):
    ...
    def __init__(self, root, name):
        self.name = name
        self.dataset_dir = osp.join(root, name)
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        for image_name in images:
            ...
            # query
                ...
                img_id = int(image_name.split('.')[0].split('_')[0])
                tru_id = image_name.split('.')[0].split('_')[1]
                dataset.append((image_path, img_id, tru_id))
